...
public class OtaPageLocators extends CommonPageLocators {
	...
	public static final By OTA_LINK = By.xpath("//a[@ng-reflect-router-link=\"ota-batch-page\"] ");
	public static final By MANUAL_OTA_BUTTON = By
			.xpath("//button[@class='primary-button' and contains(text(), 'Manual OTA')]");
	...
	public static final By ABORT_BTN = By
			.xpath("//button[contains(@class,'delete-button' ) and contains(text(),'ABORT')]");
	...
	public static final By BATCH_OTA_LINK = By
			.xpath("//button[@class='primary-button' and contains(text(), 'Create New Batch')]");
